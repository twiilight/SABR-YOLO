...
from .modules import (
    ...
    DynamicConcatLST,
    DynamicConcatECA,
    BranchReweightConcat2,
    BranchReweightConcat3,
    FEM,
    FFM_Concat,
    SCAM,
    SkipC3,
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            args = [ch[f]]
        elif m in frozenset({Concat, DynamicConcat, DynamicConcatLST, DynamicConcatECA, BranchReweightConcat2,
                             BranchReweightConcat3, FFM_Concat}):
            ...
            c1 = ch[f]
            args = [*args[1:]]
        elif m in frozenset({SelectConv}):
            c2 = 1
        else:
            c2 = ch[f]
